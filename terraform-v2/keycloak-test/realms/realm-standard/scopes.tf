module "common_scope_mappers" {
  source     = "github.com/bcgov/sso-terraform-modules?ref=main/modules/scope-common-mappers"
  realm_id   = module.realm.id
  scope_name = "common"
}

module "idir_scope_mappers" {
  source     = "github.com/bcgov/sso-terraform-modules?ref=main/modules/scope-attribute-mappers"
  realm_id   = module.realm.id
