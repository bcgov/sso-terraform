module "roadsafety-digital-forms-gold-4355" {
  ...
  web_origins = [
    "http://localhost:3000/*",
    "http://localhost:3000/roadside-forms/*",
    "http://localhost:8080/*",
    ...
    "https://rsbc-dh-prohibition-web-app-pilot-test.apps.silver.devops.gov.bc.ca/*",
    "https://rsbc-dh-prohibition-web-app-pilot-test.apps.silver.devops.gov.bc.ca/roadside-forms/*",
