...
module "education-common-4080" {
  ...
  valid_redirect_uris = [
    "https://soam-prod.apps.silver.devops.gov.bc.ca/auth/realms/master/broker/gold-basic-bceid/endpoint",
    "https://soam-prod.apps.silver.devops.gov.bc.ca/auth/realms/master/broker/gold-idir/endpoint"
  ]
}
