module "virtual-home-energy-rating-system-4932" {
  ...
  valid_redirect_uris = [
    "https://bc-emli-pin-mgmt-be-c82b4c-prod.apps.silver.devops.gov.bc.ca/oauth",
    "https://bc-emli-pin-mgmt-be-c82b4c-prod.apps.silver.devops.gov.bc.ca/oauth/logout",
